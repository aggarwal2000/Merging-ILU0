...
{	
	...
	{
		Batched_conv_ILU_app1_Preconditioned_BiCGSTAB_merged_Gpu(subdir, A_pages, b_pages, x_pages, is_scaled,  solver_results);
	...
	specifics = std::string("conv_ILU_app1_merged_");
